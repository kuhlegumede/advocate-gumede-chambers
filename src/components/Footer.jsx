    ...
    <footer className="footer">
      <div className="container footer__grid">
        <div className="footer__brand">
          <span className="footer__monogram">NG</span>
          <div>
        ...
        <div className="footer__col">
          ...
          <p>
            <a href="tel:+27827687765">082 961 8609</a><br />
            <a href="mailto:advgumede26@gmail.com">advgumede26@gmail.com</a>
          </p>
        </div>
